window.addEventListener('DOMContentLoaded', (event) => {
    ...
    van.add(document.body, VanButton.make({text:'ボタン', onPushed:(e)=>{console.log(`ボタンを押したよ！ ${Date.now()}`);console.log(e);}, onLongPushed:(e)=>{console.log('長〜く押したよ〜ん！');console.log(e);}, isOnce:true}).element)
});
