...
class VanButton extends HTMLElement {
    //static #ATTRS = 'onpush,onhold,onced,disabled,radiused,hold,once,radius,colors,light,dark,noon,night'.split(',')
    static #ATTRS = 'onpush,onhold,onced,disabled,radiused,light,dark,noon,night,data-hold-time,data-once-time,data--radius,data-colors,data-color-scheme'.split(',')
...
//            case 'colors': return this.colors = newValue
            case 'data-hold-time': return this.holdTime = newValue
            case 'data-once-time': return this.onceTime = newValue
            case 'data-radius': return this.radius = newValue
            case 'data-colors': return this.colors = newValue
            case 'data-color-scheme': return this.colorScheme = newValue
    ...
    /*
    this.dataset.holdTime = 
    this.dataset.onceTime = 
    this.dataset.radius = 
    this.dataset.colors = 
